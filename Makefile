...
tests: trans-no_nested_borrows trans-paper \
	...
	trans-loops \
	trans-array trans-traits trans-demo # TODO: generalize to all backends
...
tfstar-traits: OPTIONS +=
tcoq-traits: OPTIONS +=
tlean-traits: SUBDIR :=
tlean-traits: OPTIONS +=
thol4-traits: OPTIONS +=

trans-demo: OPTIONS += -no-state -no-split-files
trans-demo: SUBDIR := demo
tfstar-demo: OPTIONS +=
tcoq-demo: OPTIONS +=
tlean-demo: SUBDIR :=
tlean-demo: OPTIONS +=
...
# TODO: activate the demo for all the backends
thol4-demo:
	echo "Ignoring the demo test for HOL4"
