...
-- [issue_1051_nonzero_dup_parent_clause]
import Aeneas
...
namespace issue_1051_nonzero_dup_parent_clause
...
@[rust_trait "core::num::nonzero::ZeroablePrimitive"
  (parentClauses := ["markerCopySelfInst", "privateSealedInst", "markerCopySelf_NonZeroInnerInst"])]
structure core.num.nonzero.ZeroablePrimitive (Self : Type) (Self_NonZeroInner :
  ...
  markerCopySelf_NonZeroInnerInst : core.marker.Copy Self_NonZeroInner
...
def U8.Insts.CoreNumNonzeroZeroablePrimitiveNonZeroU8Inner :
  ...
  markerCopySelf_NonZeroInnerInst :=
...
/-- [issue_1051_nonzero_dup_parent_clause::get_inner]:
    Source: 'tests/src/issue-1051-nonzero-dup-parent-clause.rs', lines 10:0-12:1
    Visibility: public -/
def get_inner
...
end issue_1051_nonzero_dup_parent_clause
