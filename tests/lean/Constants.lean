...
/-- [constants::incr]:
    ...
    Visibility: public -/
def incr (n : Std.U32) : RustM Std.U32 := do
  n + 1#u32

/-- [constants::X3]
    Source: 'tests/src/constants.rs', lines 16:0-16:29
    Visibility: public -/
@[global_simps, irreducible] def X3 : RustM Std.U32 := incr 32#u32

/-- [constants::mk_pair0]:
    Source: 'tests/src/constants.rs', lines 24:0-26:1
    Visibility: public -/
def mk_pair0 (x : Std.U32) (y : Std.U32) : RustM (Std.U32 × Std.U32) := do
  ok (x, y)
...
/-- [constants::mk_pair1]:
    ...
    Visibility: public -/
def mk_pair1 (x : Std.U32) (y : Std.U32) : RustM (Pair Std.U32 Std.U32) := do
  ok { x, y }
...
def P0 : RustM (Std.U32 × Std.U32) := mk_pair0 0#u32 1#u32

/-- [constants::P1]
    Source: 'tests/src/constants.rs', lines 33:0-33:46
    Visibility: public -/
@[global_simps, irreducible]
def P1 : RustM (Pair Std.U32 Std.U32) := mk_pair1 0#u32 1#u32
...
/-- [constants::{constants::Wrap<T>}::new]:
    ...
    Visibility: public -/
def Wrap.new {T : Type} (value : T) : RustM (Wrap T) := do
  ok { value }

/-- [constants::Y]
    Source: 'tests/src/constants.rs', lines 42:0-42:38
    Visibility: public -/
@[global_simps, irreducible] def Y : RustM (Wrap Std.I32) := Wrap.new 2#i32

/-- [constants::unwrap_y]:
    Source: 'tests/src/constants.rs', lines 44:0-46:1
    Visibility: public -/
def unwrap_y : RustM Std.I32 := do
  let w ← Y
  ok w.value
...
/-- [constants::YVAL]
    ...
    Visibility: public -/
@[global_simps, irreducible] def YVAL : RustM Std.I32 := unwrap_y
...
/-- [constants::get_z1]:
    ...
    Visibility: public -/
def get_z1 : RustM Std.I32 := do
  ok get_z1.Z1

/-- [constants::add]:
    Source: 'tests/src/constants.rs', lines 67:0-69:1
    Visibility: public -/
def add (a : Std.I32) (b : Std.I32) : RustM Std.I32 := do
  a + b
...
/-- [constants::Q3]
    ...
    Visibility: public -/
@[global_simps, irreducible] def Q3 : RustM Std.I32 := add Q2 3#i32

/-- [constants::get_z2]:
    Source: 'tests/src/constants.rs', lines 71:0-73:1
    Visibility: public -/
def get_z2 : RustM Std.I32 := do
  let i ← get_z1
  let i1 ← Q3
  let i2 ← add i i1
  add Q1 i2
...
/-- [constants::S2]
    ...
    Visibility: public -/
@[global_simps, irreducible] def S2 : RustM Std.U32 := incr S1
...
/-- [constants::S4]
    ...
    Visibility: public -/
@[global_simps, irreducible]
def S4 : RustM (Pair Std.U32 Std.U32) := mk_pair1 7#u32 8#u32
...
/-- [constants::use_v]:
    ...
    Visibility: public -/
def use_v (T : Type) (N : Std.Usize) : RustM Std.Usize := do
  ok (V.LEN T N)
