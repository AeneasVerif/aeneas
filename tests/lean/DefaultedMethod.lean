...
structure Trait (Self : Type) where
  provided_method : Self → RustM Std.U32
  required_method : Self → RustM Std.U32
...
def Trait.provided_method.default
  {Self : Type} (TraitInst : Trait Self) (self : Self) : RustM Std.U32 := do
...
def NoOverride.Insts.Defaulted_methodTrait.required_method
  (self : NoOverride) : RustM Std.U32 := do
  ok 12#u32
...
def YesOverride.Insts.Defaulted_methodTrait.required_method
  (self : YesOverride) : RustM Std.U32 := do
  ok 42#u32
