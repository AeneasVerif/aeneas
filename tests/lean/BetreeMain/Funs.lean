...
def betree.Leaf.split
  ...
  Result.ok (st2, (betree.Internal.mk self.id pivot n n1, nic1))
  ...
  | betree.Node.Internal node =>
    ...
    | betree.List.Cons p l =>
      ...
      then
        ...
        Result.ok (st2, (o, betree.Node.Internal i2))
      else
        match msg with
        | betree.Message.Insert v =>
          do
        ...
        | betree.Message.Upsert ufs =>
          ...
          Result.ok (st4, (some v1, betree.Node.Internal (betree.Internal.mk i3
            i4 n2 n3)))
    | betree.List.Nil =>
      do
      let (st2, (o, i2)) ←
...
divergent def betree.Node.apply_messages
  ...
  | betree.Node.Leaf node =>
    ...
    then
      ...
      Result.ok (st3, (betree.Node.Internal new_node, nic))
    else
      do
