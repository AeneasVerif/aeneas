...
/-- [bitwise::shift_u32]:
    ...
    Visibility: public -/
def shift_u32 (a : Std.U32) : RustM Std.U32 := do
  let t ← a >>> 16#usize
  t <<< 16#usize
...
/-- [bitwise::shift_i32]:
    ...
    Visibility: public -/
def shift_i32 (a : Std.I32) : RustM Std.I32 := do
  let t ← a >>> 16#isize
  t <<< 16#isize
...
/-- [bitwise::xor_u32]:
    ...
    Visibility: public -/
def xor_u32 (a : Std.U32) (b : Std.U32) : RustM Std.U32 := do
  ok (a ^^^ b)

/-- [bitwise::or_u32]:
    Source: 'tests/src/bitwise.rs', lines 22:0-24:1
    Visibility: public -/
def or_u32 (a : Std.U32) (b : Std.U32) : RustM Std.U32 := do
  ok (a ||| b)

/-- [bitwise::and_u32]:
    Source: 'tests/src/bitwise.rs', lines 26:0-28:1
    Visibility: public -/
def and_u32 (a : Std.U32) (b : Std.U32) : RustM Std.U32 := do
  ok (a &&& b)

/-- [bitwise::and_bool]:
    Source: 'tests/src/bitwise.rs', lines 30:0-32:1
    Visibility: public -/
def and_bool (a : Bool) (b : Bool) : RustM Bool := do
  ok (a && b)

/-- [bitwise::or_bool]:
    Source: 'tests/src/bitwise.rs', lines 34:0-36:1
    Visibility: public -/
def or_bool (a : Bool) (b : Bool) : RustM Bool := do
  ok (a || b)

/-- [bitwise::xor_bool]:
    Source: 'tests/src/bitwise.rs', lines 38:0-40:1
    Visibility: public -/
def xor_bool (a : Bool) (b : Bool) : RustM Bool := do
  ok (a ^^ b)
