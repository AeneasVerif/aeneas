...
/-- [rename_attribute::test_bool_trait]:
    ...
    Visibility: public -/
def BoolFn (T : Type) (x : Bool) : RustM Bool := do
...
def Const_Test : RustM Std.U32 := do let i ← 100#u32 + 10#u32
                                     i + 1#u32

/-- [rename_attribute::CA]
    Source: 'tests/src/rename_attribute.rs', lines 55:0-55:23 -/
@[global_simps, irreducible]
def Const_Aeneas11 : RustM Std.U32 := 10#u32 + 1#u32

/-- [rename_attribute::factorial]:
    Source: 'tests/src/rename_attribute.rs', lines 58:0-64:1 -/
def Factfn (n : Std.U64) : RustM Std.U64 := do
  if n <= 1#u64
  then ok 1#u64
  else let i ← n - 1#u64
       let i1 ← Factfn i
...
/-- [rename_attribute::sum]:
    ...
    Visibility: public -/
def No_borrows_sum (max : Std.U32) : RustM Std.U32 := do
