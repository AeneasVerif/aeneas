...
structure BoolTrait (Self : Type) where
  get_bool : Self → RustM Bool
  ret_true : Self → RustM Bool

/-- [traits::BoolTrait::ret_true]:
    Source: 'tests/src/traits.rs', lines 8:4-10:5
    Visibility: public -/
@[trait_default]
def BoolTrait.ret_true.default {Self : Type} (self : Self) : RustM Bool := do
  ok true

/-- [traits::{impl traits::BoolTrait for bool}::get_bool]:
    Source: 'tests/src/traits.rs', lines 14:4-16:5
    Visibility: public -/
def Bool.Insts.TraitsBoolTrait.get_bool (self : Bool) : RustM Bool := do
  ok self
...
/-- [traits::test_bool_trait_bool]:
    ...
    Visibility: public -/
def test_bool_trait_bool (x : Bool) : RustM Bool := do
...
def core.option.Option.Insts.TraitsBoolTrait.get_bool
  {T : Type} (self : Option T) : RustM Bool := do
  match self with
  | none => ok false
  | some _ => ok true
...
/-- [traits::test_bool_trait_option]:
    ...
    Visibility: public -/
def test_bool_trait_option {T : Type} (x : Option T) : RustM Bool := do
...
/-- [traits::test_bool_trait]:
    ...
    Visibility: public -/
def test_bool_trait
  {T : Type} (BoolTraitInst : BoolTrait T) (x : T) : RustM Bool := do
...
structure ToU64 (Self : Type) where
  to_u64 : Self → RustM Std.U64

/-- [traits::{impl traits::ToU64 for u64}::to_u64]:
    Source: 'tests/src/traits.rs', lines 46:4-48:5
    Visibility: public -/
def U64.Insts.TraitsToU64.to_u64 (self : Std.U64) : RustM Std.U64 := do
  ok self
...
def Pair.Insts.TraitsToU64.to_u64
  {A : Type} (ToU64Inst : ToU64 A) (self : (A × A)) : RustM Std.U64 := do
  let (t, t1) := self
...
/-- [traits::f]:
    ...
    Visibility: public -/
def f {T : Type} (ToU64Inst : ToU64 T) (x : (T × T)) : RustM Std.U64 := do
...
/-- [traits::h0]:
    ...
    Visibility: public -/
def h0 (x : Std.U64) : RustM Std.U64 := do
...
def Wrapper.Insts.TraitsToU64.to_u64
  {T : Type} (ToU64Inst : ToU64 T) (self : Wrapper T) : RustM Std.U64 := do
...
/-- [traits::h1]:
    ...
    Visibility: public -/
def h1 (x : Wrapper Std.U64) : RustM Std.U64 := do
  Wrapper.Insts.TraitsToU64.to_u64 U64.Insts.TraitsToU64 x

/-- [traits::h2]:
    Source: 'tests/src/traits.rs', lines 86:0-88:1
    Visibility: public -/
def h2 {T : Type} (ToU64Inst : ToU64 T) (x : Wrapper T) : RustM Std.U64 := do
...
structure OfType (Self : Type) where
  of_type : forall {T : Type} (ToTypeInst : ToType T Self), T → RustM Self
...
def TestType.test.TestType1.Insts.TraitsTestTypeTestTestTrait.test
  (self : TestType.test.TestType1) : RustM Bool := do
  ok (self > 1#u64)
...
structure WithConstTy (Self : Type) (Self_V : Type) (Self_W : Type) (LEN :
  Std.Usize) where
  LEN1 : RustM Std.Usize
  LEN2 : RustM Std.Usize
  ToU64Inst : ToU64 Self_W
  f : Self_W → Array Std.U8 LEN → RustM Self_W
...
def Bool.Insts.TraitsWithConstTyU8U6432.f
  (i : Std.U64) (a : Array Std.U8 32#usize) : RustM Std.U64 := do
  ok i
...
/-- [traits::test_where1]:
    ...
    Visibility: public -/
def test_where1 {T : Type} (_x : T) : RustM Unit := do
  ok ()
...
structure ParentTrait0 (Self : Type) (Self_W : Type) where
  get_name : Self → RustM String
  get_w : Self → RustM Self_W
...
structure ChildTrait2 (Self : Type) (Self_Clause0_U : Type)
  ...
  convert : Self_Clause0_U → RustM Self_Clause0_Clause0_Target
...
/-- [traits::use_wrapper_len]:
    ...
    Visibility: public -/
def use_wrapper_len {T : Type} (TraitInst : Trait T) : RustM Std.Usize := do
...
def use_foo1
  ...
  RustM (core.result.Result T Std.I32)
  := do
...
def use_foo2
  ...
  RustM (core.result.Result U Std.I32)
  := do
