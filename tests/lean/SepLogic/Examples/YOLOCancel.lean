...
Those sizes currently exhaust impractical amounts of memory in `iframe`, so
...
```
lake env lean -M3072 -j1 SepLogic/Examples/YOLOCancel.lean
```
...
namespace SepLogic.YOLOCancel

set_option maxRecDepth 100000
set_option maxHeartbeats 600000

set_option trace.profiler true in
theorem q10 (H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 : IProp) :
...
set_option trace.profiler true in
theorem q20 (H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 H14 H15 H16 H17 H18 H19 H20 : IProp) :
...
set_option trace.profiler true in
theorem q30 (H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 H14 H15 H16 H17 H18 H19 H20 H21 H22 H23 H24 H25 H26 H27 H28 H29 H30 : IProp) :
...
set_option trace.profiler true in
theorem q40 (H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 H14 H15 H16 H17 H18 H19 H20 H21 H22 H23 H24 H25 H26 H27 H28 H29 H30 H31 H32 H33 H34 H35 H36 H37 H38 H39 H40 : IProp) :
