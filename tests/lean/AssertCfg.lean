...
def get_b0 : RustM Bool := do
  ok true

/-- [assert_cfg::get_b1]:
    Source: 'tests/src/assert-cfg.rs', lines 7:0-9:1 -/
def get_b1 : RustM Bool := do
  ok true
...
/-- [assert_cfg::assert_or]:
    ...
    Visibility: public -/
def assert_or (b0 : Bool) (b1 : Bool) : RustM Unit := do
  massert (b0 || b1)
  f
...
/-- [assert_cfg::assert_and]:
    ...
    Visibility: public -/
def assert_and (b0 : Bool) (b1 : Bool) : RustM Unit := do
  massert b0
  massert b1
  f
...
/-- [assert_cfg::assert_not_or]:
    ...
    Visibility: public -/
def assert_not_or (b0 : Bool) (b1 : Bool) : RustM Unit := do
  massert (¬ b0)
  massert (¬ b1)
  f
...
/-- [assert_cfg::assert_not_and]:
    ...
    Visibility: public -/
def assert_not_and (b0 : Bool) (b1 : Bool) : RustM Unit := do
  massert ((¬ b0) || (¬ b1))
  f
...
/-- [assert_cfg::assert_not_b0_or_b1]:
    ...
    Visibility: public -/
def assert_not_b0_or_b1 (b0 : Bool) (b1 : Bool) : RustM Unit := do
  massert ((¬ b0) || b1)
  f
...
/-- [assert_cfg::assert_b0_or_not_b1]:
    ...
    Visibility: public -/
def assert_b0_or_not_b1 (b0 : Bool) (b1 : Bool) : RustM Unit := do
  massert (b0 || (¬ b1))
  f
...
/-- [assert_cfg::assert_not_b0_or_not_b1]:
    ...
    Visibility: public -/
def assert_not_b0_or_not_b1 (b0 : Bool) (b1 : Bool) : RustM Unit := do
  massert ((¬ b0) || (¬ b1))
  f
...
/-- [assert_cfg::assert_not_b0_and_b1]:
    ...
    Visibility: public -/
def assert_not_b0_and_b1 (b0 : Bool) (b1 : Bool) : RustM Unit := do
  massert (¬ b0)
  massert b1
  f
...
/-- [assert_cfg::assert_b0_and_not_b1]:
    ...
    Visibility: public -/
def assert_b0_and_not_b1 (b0 : Bool) (b1 : Bool) : RustM Unit := do
  massert b0
  massert (¬ b1)
  f
...
/-- [assert_cfg::assert_not_b0_and_not_b1]:
    ...
    Visibility: public -/
def assert_not_b0_and_not_b1 (b0 : Bool) (b1 : Bool) : RustM Unit := do
  massert (¬ b0)
  massert (¬ b1)
  f
...
/-- [assert_cfg::assert_or_call]:
    ...
    Visibility: public -/
def assert_or_call : RustM Unit := do
  let b ← get_b0
  if b
  then ok ()
  else do
...
/-- [assert_cfg::assert_and_call]:
    ...
    Visibility: public -/
def assert_and_call : RustM Unit := do
  let b ← get_b0
  massert b
  let b1 ← get_b1
  massert b1
...
/-- [assert_cfg::assert_not_or_call]:
    ...
    Visibility: public -/
def assert_not_or_call : RustM Unit := do
  let b ← get_b0
  massert (¬ b)
  let b1 ← get_b1
  massert (¬ b1)
...
/-- [assert_cfg::assert_not_and_call]:
    ...
    Visibility: public -/
def assert_not_and_call : RustM Unit := do
  let b ← get_b0
  if b
  then do
       let b1 ← get_b1
...
/-- [assert_cfg::assert_not_b0_or_b1_call]:
    ...
    Visibility: public -/
def assert_not_b0_or_b1_call : RustM Unit := do
  let b ← get_b0
  if b
  then do
       let b1 ← get_b1
...
/-- [assert_cfg::assert_b0_or_not_b1_call]:
    ...
    Visibility: public -/
def assert_b0_or_not_b1_call : RustM Unit := do
  let b ← get_b0
  if b
  then ok ()
  else do
...
/-- [assert_cfg::assert_not_b0_or_not_b1_call]:
    ...
    Visibility: public -/
def assert_not_b0_or_not_b1_call : RustM Unit := do
  let b ← get_b0
  if b
  then do
       let b1 ← get_b1
...
/-- [assert_cfg::assert_not_b0_and_b1_call]:
    ...
    Visibility: public -/
def assert_not_b0_and_b1_call : RustM Unit := do
  let b ← get_b0
  massert (¬ b)
  let b1 ← get_b1
  massert b1
...
/-- [assert_cfg::assert_b0_and_not_b1_call]:
    ...
    Visibility: public -/
def assert_b0_and_not_b1_call : RustM Unit := do
  let b ← get_b0
  massert b
  let b1 ← get_b1
  massert (¬ b1)
...
/-- [assert_cfg::assert_not_b0_and_not_b1_call]:
    ...
    Visibility: public -/
def assert_not_b0_and_not_b1_call : RustM Unit := do
  let b ← get_b0
  massert (¬ b)
  let b1 ← get_b1
  massert (¬ b1)
...
/-- [assert_cfg::assert_lt]:
    ...
    Visibility: public -/
def assert_lt (x : Std.U32) : RustM Unit := do
  massert (x < 10#u32)
  f
...
/-- [assert_cfg::assert_le]:
    ...
    Visibility: public -/
def assert_le (x : Std.U32) : RustM Unit := do
  massert (x <= 3494#u32)
  f
...
/-- [assert_cfg::assert_gt]:
    ...
    Visibility: public -/
def assert_gt (x : Std.U32) : RustM Unit := do
  massert (x > 0#u32)
  f
...
/-- [assert_cfg::assert_ge]:
    ...
    Visibility: public -/
def assert_ge (x : Std.U32) : RustM Unit := do
  massert (x >= 1#u32)
  f
...
/-- [assert_cfg::assert_eq]:
    ...
    Visibility: public -/
def assert_eq (x : Std.U32) : RustM Unit := do
  massert (x = 42#u32)
  f
...
/-- [assert_cfg::assert_ne]:
    ...
    Visibility: public -/
def assert_ne (x : Std.U32) : RustM Unit := do
  massert (x != 0#u32)
  f
...
/-- [assert_cfg::assert_arith]:
    ...
    Visibility: public -/
def assert_arith (x : Std.U32) (y : Std.U32) : RustM Unit := do
  let i ← x + y
  massert (i < 100#u32)
  f
...
def assert_in_loop_loop.body
  ...
  RustM (ControlFlow (core.ops.range.Range Std.Usize) Unit)
  := do
  let (o, iter1) ←
...
@[reducible]
def assert_in_loop (a : Array Std.U32 10#usize) : RustM Unit := do
...
def assert_or_in_loop_loop.body
  (iter : core.ops.range.Range Std.Usize) (a : Array Std.U32 10#usize) :
  RustM (ControlFlow ((core.ops.range.Range Std.Usize) × (Array Std.U32
...
def assert_or_in_loop
  (a : Array Std.U32 10#usize) : RustM (Array Std.U32 10#usize) := do
