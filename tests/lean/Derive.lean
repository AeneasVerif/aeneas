...
axiom Bool.Insts.CoreCmpPartialEqBool.ne : Bool → Bool → RustM Bool
...
def CopyEnumOneVariant.Insts.CoreCloneClone.clone
  (self : CopyEnumOneVariant) : RustM CopyEnumOneVariant := do
  ok self
...
def CopyEnumOneVariant.Insts.CoreCmpPartialEqCopyEnumOneVariant.eq
  (self : CopyEnumOneVariant) (other : CopyEnumOneVariant) : RustM Bool := do
  let ⟨ __self_0 ⟩ := self
  let ⟨ __arg1_0 ⟩ := other
...
def CopyEnumOneVariant.Insts.CoreCmpEq.assert_fields_are_eq
  (self : CopyEnumOneVariant) : RustM Unit := do
  ok ()
...
def ScalarEnum.Insts.CoreCloneClone.clone
  (self : ScalarEnum) : RustM ScalarEnum := do
  ok self
...
def ScalarEnum.Insts.CoreCmpPartialEqScalarEnum.eq
  (self : ScalarEnum) (other : ScalarEnum) : RustM Bool := do
...
def Enum.Insts.CoreCmpEq.assert_fields_are_eq
  {T : Type} (corecmpEqInst : core.cmp.Eq T) (self : Enum T) : RustM Unit := do
  ok ()
...
def List.Insts.CoreCmpEq.assert_fields_are_eq
  {T : Type} (corecmpEqInst : core.cmp.Eq T) (self : List T) : RustM Unit := do
  ok ()
...
def Struct6Fields.Insts.CoreCloneClone.clone
  (self : Struct6Fields) : RustM Struct6Fields := do
...
def Struct6Fields.Insts.CoreCmpPartialEqStruct6Fields.eq
  (self : Struct6Fields) (other : Struct6Fields) : RustM Bool := do
  if self.a = other.a
  then
    if self.b = other.b
    then
...
def Struct6Fields.Insts.CoreCmpEq.assert_fields_are_eq
  (self : Struct6Fields) : RustM Unit := do
  ok ()
...
/-- [derive::refs_ne]:
    ...
    Visibility: public -/
def refs_ne (a : Struct6Fields) (b : Struct6Fields) : RustM Bool := do
...
/-- [derive::refs_eq]:
    ...
    Visibility: public -/
def refs_eq (a : Struct6Fields) (b : Struct6Fields) : RustM Bool := do
