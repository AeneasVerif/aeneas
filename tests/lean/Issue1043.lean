...
/-- [issue_1043::indexed_squares::closure]
    Source: 'tests/src/issue-1043.rs', lines 9:25-9:46 -/
@[reducible]
def indexed_squares.closure (I : Type) := Unit

/-- [issue_1043::indexed_squares::{impl core::ops::function::FnMut<((usize, u32),), u32> for issue_1043::indexed_squares::closure<I>}::call_mut]:
    Source: 'tests/src/issue-1043.rs', lines 9:25-9:46 -/
def
...
/-- [issue_1043::indexed_squares::{impl core::ops::function::FnOnce<((usize, u32),), u32> for issue_1043::indexed_squares::closure<I>}::call_once]:
    Source: 'tests/src/issue-1043.rs', lines 9:25-9:46 -/
def
...
/-- Trait implementation: [issue_1043::indexed_squares::{impl core::ops::function::FnOnce<((usize, u32),), u32> for issue_1043::indexed_squares::closure<I>}]
    Source: 'tests/src/issue-1043.rs', lines 9:25-9:46 -/
@[reducible]
...
/-- Trait implementation: [issue_1043::indexed_squares::{impl core::ops::function::FnMut<((usize, u32),), u32> for issue_1043::indexed_squares::closure<I>}]
    Source: 'tests/src/issue-1043.rs', lines 9:25-9:46 -/
@[reducible]
...
/-- [issue_1043::indexed_squares]:
    Source: 'tests/src/issue-1043.rs', lines 8:0-10:1
    Visibility: public -/
def indexed_squares
  {I : Type} (coreitertraitsiteratorIteratorIU32Inst :
...
/-- [issue_1043::call_it]:
    Source: 'tests/src/issue-1043.rs', lines 12:0-14:1
    Visibility: public -/
