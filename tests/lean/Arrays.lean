...
def array_to_shared_slice_
  {T : Type} (s : Array T 32#usize) : RustM (Slice T) := do
  ok (Array.to_slice s)
...
def array_to_mut_slice_
  ...
  RustM ((Slice T) × (Slice T → Array T 32#usize))
  := do
...
/-- [arrays::array_len]:
    ...
    Visibility: public -/
def array_len {T : Type} (s : Array T 32#usize) : RustM Std.Usize := do
...
/-- [arrays::shared_array_len]:
    ...
    Visibility: public -/
def shared_array_len {T : Type} (s : Array T 32#usize) : RustM Std.Usize := do
  let s1 ← lift (Array.to_slice s)
  ok (Slice.len s1)
...
/-- [arrays::shared_slice_len]:
    ...
    Visibility: public -/
def shared_slice_len {T : Type} (s : Slice T) : RustM Std.Usize := do
  ok (Slice.len s)
...
def index_array_shared
  {T : Type} (s : Array T 32#usize) (i : Std.Usize) : RustM T := do
...
/-- [arrays::index_array_u32]:
    ...
    Visibility: public -/
def index_array_u32
  (s : Array Std.U32 32#usize) (i : Std.Usize) : RustM Std.U32 := do
  Array.index_usize s i

/-- [arrays::index_array_copy]:
    Source: 'tests/src/arrays.rs', lines 53:0-55:1
    Visibility: public -/
def index_array_copy (x : Array Std.U32 32#usize) : RustM Std.U32 := do
...
/-- [arrays::index_slice]:
    ...
    Visibility: public -/
def index_slice {T : Type} (s : Slice T) (i : Std.Usize) : RustM T := do
...
/-- [arrays::index_mut_slice]:
    ...
    Visibility: public -/
def index_mut_slice
  {T : Type} (s : Slice T) (i : Std.Usize) : RustM (T × (T → Slice T)) := do
...
def slice_subslice_mut_
  (x : Slice Std.U32) (y : Std.Usize) (z : Std.Usize) :
  RustM ((Slice Std.U32) × (Slice Std.U32 → Slice Std.U32))
  := do
...
def array_to_slice_shared_
  (x : Array Std.U32 32#usize) : RustM (Slice Std.U32) := do
  ok (Array.to_slice x)
...
def array_to_slice_mut_
  ...
  RustM ((Slice Std.U32) × (Slice Std.U32 → Array Std.U32 32#usize))
  := do
...
/-- [arrays::index_slice_0]:
    ...
    Visibility: public -/
def index_slice_0 {T : Type} (s : Slice T) : RustM T := do
  Slice.index_usize s 0#usize

/-- [arrays::index_array_0]:
    Source: 'tests/src/arrays.rs', lines 97:0-99:1
    Visibility: public -/
def index_array_0 {T : Type} (s : Array T 32#usize) : RustM T := do
...
def update_update_array
  (s : Array (Array Std.U32 32#usize) 32#usize) (i : Std.Usize) (j : Std.Usize)
  :
  RustM (Array (Array Std.U32 32#usize) 32#usize)
  := do
...
/-- [arrays::array_local_deep_copy]:
    ...
    Visibility: public -/
def array_local_deep_copy (x : Array Std.U32 32#usize) : RustM Unit := do
  ok ()
...
/-- [arrays::index_array]:
    ...
    Visibility: public -/
def index_array (x : Array Std.U32 2#usize) : RustM Std.U32 := do
  Array.index_usize x 0#usize

/-- [arrays::index_array_borrow]:
    Source: 'tests/src/arrays.rs', lines 181:0-183:1
    Visibility: public -/
def index_array_borrow (x : Array Std.U32 2#usize) : RustM Std.U32 := do
  Array.index_usize x 0#usize

/-- [arrays::index_slice_u32_0]:
    Source: 'tests/src/arrays.rs', lines 185:0-187:1
    Visibility: public -/
def index_slice_u32_0 (x : Slice Std.U32) : RustM Std.U32 := do
...
def index_mut_slice_u32_0
  (x : Slice Std.U32) : RustM (Std.U32 × (Slice Std.U32)) := do
...
/-- [arrays::index_all]:
    ...
    Visibility: public -/
def index_all : RustM Std.U32 := do
  let x := Array.repeat 2#usize 0#u32
  let i ← index_array x
  let i1 ← i + i
...
/-- [arrays::update_array]:
    ...
    Visibility: public -/
def update_array (x : Array Std.U32 2#usize) : RustM Unit := do
...
/-- [arrays::incr_slice]:
    ...
    Visibility: public -/
def incr_slice (x : Slice Std.U32) : RustM (Slice Std.U32) := do
  let i ← Slice.index_usize x 0#usize
  let i1 ← i + 1#u32
...
/-- [arrays::deref_array_borrow]:
    ...
    Visibility: public -/
def deref_array_borrow (x : Array Std.U32 2#usize) : RustM Std.U32 := do
  Array.index_usize x 0#usize
...
def deref_array_mut_borrow
  ...
  RustM (Std.U32 × (Array Std.U32 2#usize))
  := do
  let i ← Array.index_usize x 0#usize
  ok (i, x)
...
/-- [arrays::take_array_t]:
    ...
    Visibility: public -/
def take_array_t (a : Array AB 2#usize) : RustM Unit := do
  ok ()

/-- [arrays::non_copyable_array]:
    Source: 'tests/src/arrays.rs', lines 260:0-268:1
    Visibility: public -/
def non_copyable_array : RustM Unit := do
...
def sum_loop.body
  ...
  RustM (ControlFlow (Std.U32 × Std.Usize) Std.U32)
  := do
  let i1 := Slice.len s
  if i < i1
  then
...
@[rust_loop]
def sum_loop
  (s : Slice Std.U32) (sum1 : Std.U32) (i : Std.Usize) : RustM Std.U32 := do
  loop
...
/-- [arrays::sum]:
    ...
    Visibility: public -/
@[reducible]
def sum (s : Slice Std.U32) : RustM Std.U32 := do
...
/-- [arrays::sum2]:
    ...
    Visibility: public -/
def sum2 (s : Slice Std.U32) (s2 : Slice Std.U32) : RustM Std.U32 := do
  let i := Slice.len s
  let i1 := Slice.len s2
  massert (i = i1)
...
/-- [arrays::f2]:
    ...
    Visibility: public -/
def f2 (i : Std.U32) : RustM Unit := do
  ok ()
...
/-- [arrays::f5]:
    ...
    Visibility: public -/
def f5 (x : Array Std.U32 32#usize) : RustM Std.U32 := do
  Array.index_usize x 0#usize

/-- [arrays::ite]:
    Source: 'tests/src/arrays.rs', lines 325:0-332:1
    Visibility: public -/
def ite : RustM Unit := do
  let x := Array.repeat 2#usize 0#u32
...
def zero_slice_loop.body
  ...
  RustM (ControlFlow ((Slice Std.U8) × Std.Usize) (Slice Std.U8))
  := do
  if i < len
...
/-- [arrays::zero_slice]:
    ...
    Visibility: public -/
def zero_slice (a : Slice Std.U8) : RustM (Slice Std.U8) := do
  let len := Slice.len a
...
def iter_mut_slice_loop.body
  (len : Std.Usize) (i : Std.Usize) : RustM (ControlFlow Std.Usize Unit) := do
  if i < len
...
/-- [arrays::iter_mut_slice]: loop 0:
    ...
    Visibility: public -/
@[rust_loop]
def iter_mut_slice_loop (len : Std.Usize) (i : Std.Usize) : RustM Unit := do
  loop
...
/-- [arrays::iter_mut_slice]:
    ...
    Visibility: public -/
def iter_mut_slice (a : Slice Std.U8) : RustM (Slice Std.U8) := do
  let len := Slice.len a
...
def sum_mut_slice_loop
  (a : Slice Std.U32) (i : Std.Usize) (s : Std.U32) : RustM Std.U32 := do
  loop
...
/-- [arrays::sum_mut_slice]:
    ...
    Visibility: public -/
def sum_mut_slice
  (a : Slice Std.U32) : RustM (Std.U32 × (Slice Std.U32)) := do
...
def add_acc_loop.body
  ...
  (i : Std.Usize) :
  RustM (ControlFlow ((Array Std.U32 256#usize) × (Array Std.U32 256#usize) ×
...
def add_acc_loop
  (paSrc : Array Std.U32 256#usize) (peDst : Array Std.U32 256#usize)
  (i : Std.Usize) :
  RustM ((Array Std.U32 256#usize) × (Array Std.U32 256#usize))
  := do
  loop
