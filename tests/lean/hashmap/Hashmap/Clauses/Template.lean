...
/- [hashmap::HashMap::{0}::clear_slots]: termination measure -/
@[simp]
def hash_map_clear_slots_loop_terminates (T : Type) (slots : Vec (list_t T))
  (i : Usize) :=
  (slots, i)

/- [hashmap::HashMap::{0}::clear_slots]: decreases_by tactic -/
syntax "hash_map_clear_slots_loop_decreases" term+ : tactic
macro_rules
| `(tactic| hash_map_clear_slots_loop_decreases $slots $i) =>`(tactic| sorry)
