...
/// ================
/// 
/// The fact that we don't reason with tactics but with the SMT solver, in a prover
/// designed for intrinsic proofs makes it a bit awkward to reason about pure
/// functions in a modular manner, because every proof requires to basically
/// copy-paste all the functions we are studying. As a consequence, this file is
/// extremely verbose...
