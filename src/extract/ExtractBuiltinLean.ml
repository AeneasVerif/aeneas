...
let lean_builtin_funs =
  [
    ...
    (* file: "Aeneas/Std/Scalar/Ops/Add.lean", line: 185 *)
    mk_fun
    ...
    (* file: "Aeneas/Std/Core/CoreResult.lean", line: 11 *)
