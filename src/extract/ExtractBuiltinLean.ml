...
let lean_builtin_funs =
  [
    ...
    (* file: "Aeneas/Std/Vec.lean", line: 623 *)
    mk_fun
      "alloc::vec::partial_eq::{core::cmp::PartialEq<alloc::vec::Vec<@T>, \
       alloc::vec::Vec<@U>>}::ne"
    ...
    (* file: "Aeneas/Std/Vec.lean", line: 599 *)
...
let lean_builtin_trait_impls =
  [
    ...
    mk_trait_impl "core::cmp::PartialEq<Box<@T>, Box<@T>>"
      ...
      ~keep_params:(Some [ true; false ]);
    (* file: "Aeneas/Std/Vec.lean", line: 634 *)
    mk_trait_impl
    ...
    (* file: "Aeneas/Std/Vec.lean", line: 655 *)
    ...
    mk_trait_impl "core::ops::deref::DerefMut<Box<@T>, @T>"
      ...
      ~keep_params:(Some [ true; false ]);
    (* file: "Aeneas/Std/Vec.lean", line: 434 *)
