...
let lean_builtin_types =
  [
    ...
    (* file: "Aeneas/Std/Vec.lean", line: 19 *)
    ...
    (* file: "Aeneas/Std/Core/Convert.lean", line: 9 *)
    ...
    (* file: "Aeneas/Std/Range.lean", line: 36 *)
    mk_type "core::ops::range::Bound" "core.ops.range.Bound"
      ~kind:
        (KEnum
           [
    ...
    (* file: "Aeneas/Std/Range.lean", line: 27 *)
...
let lean_builtin_funs =
  [
    ...
    mk_fun "alloc::boxed::{core::cmp::PartialEq<Box<@T>, Box<@T>>}::eq"
      ...
      ~keep_params:(Some [ true; false ]);
    (* file: "Aeneas/Std/Core/Core.lean", line: 18 *)
    ...
    mk_fun
      "alloc::vec::into_iter::{core::iter::traits::iterator::Iterator<alloc::vec::into_iter::IntoIter<@T, \
       @A>, @T>}::collect"
      "alloc.vec.into_iter.IntoIter.Insts.CoreIterTraitsIteratorIterator.collect";
    ...
    mk_fun
      ...
      ~keep_params:(Some [ true; false ]);
    (* file: "Aeneas/Std/Vec.lean", line: 460 *)
    mk_fun
    ...
    (* file: "Aeneas/Std/Vec.lean", line: 470 *)
    mk_fun
      "alloc::vec::partial_eq::{core::cmp::PartialEq<alloc::vec::Vec<@T>, \
       alloc::vec::Vec<@U>>}::ne"
      "alloc.vec.partial_eq.PartialEqVec.ne"
      ~keep_params:(Some [ true; true; false; false ]);
    (* file: "Aeneas/Std/Vec.lean", line: 590 *)
    mk_fun "alloc::vec::{alloc::vec::Vec<@T>}::append" "alloc.vec.Vec.append"
      ~keep_params:(Some [ true; false ]);
    (* file: "Aeneas/Std/Vec.lean", line: 556 *)
    ...
    mk_fun
      ...
      ~keep_params:(Some [ true; false ]);
    (* file: "Aeneas/Std/Vec.lean", line: 347 *)
    mk_fun
      "alloc::vec::{core::ops::deref::Deref<alloc::vec::Vec<@T>, [@T]>}::deref"
      "alloc.vec.Vec.deref"
      ~keep_params:(Some [ true; false ])
      ~can_fail:false ~lift:false;
    (* file: "Aeneas/Std/Vec.lean", line: 357 *)
    mk_fun
    ...
    (* file: "Aeneas/Std/Array/ArraySlice.lean", line: 324 *)
    ...
    (* file: "Aeneas/Std/Array/Array.lean", line: 236 *)
    mk_fun "core::array::{core::clone::Clone<[@T; @N]>}::clone_from"
      "core.array.CloneArray.clone_from";
    (* file: "Aeneas/Std/Array/ArraySlice.lean", line: 187 *)
    mk_fun
    ...
    (* file: "Aeneas/Std/Array/ArraySlice.lean", line: 202 *)
    mk_fun
    ...
    (* file: "Aeneas/Std/Core/Fmt.lean", line: 111 *)
    ...
    (* file: "Aeneas/Std/Core/Iter.lean", line: 179 *)
    mk_fun
      "core::iter::adapters::enumerate::{core::iter::traits::iterator::Iterator<core::iter::adapters::enumerate::Enumerate<@I>, \
    ...
    mk_fun
      "core::iter::adapters::map::{core::iter::traits::iterator::Iterator<core::iter::adapters::map::Map<@I, \
       @F>, @B>}::collect"
      "core.iter.adapters.map.IteratorMap.collect";
    (* file: "Aeneas/Std/Core/Iter.lean", line: 573 *)
    mk_fun
      "core::iter::adapters::map::{core::iter::traits::iterator::Iterator<core::iter::adapters::map::Map<@I, \
       @F>, @B>}::map"
      "core.iter.adapters.map.IteratorMap.map";
    ...
    (* file: "Aeneas/Std/Core/Iter.lean", line: 348 *)
    mk_fun
    ...
    mk_fun
      "core::iter::range::{core::iter::traits::iterator::Iterator<core::ops::range::Range<@A>, \
       @A>}::collect"
      "core.ops.range.Range.IteratorRange.collect";
    ...
    mk_fun
      "core::iter::range::{core::iter::traits::iterator::Iterator<core::ops::range::Range<@A>, \
       @A>}::map"
      "core.ops.range.Range.IteratorRange.map";
    ...
    (* file: "Aeneas/Std/Slice.lean", line: 933 *)
    mk_fun
      "core::ops::range::{core::ops::range::RangeBounds<core::ops::range::Range<@T>, \
       @T>}::end_bound"
      "core.ops.range.Range.RangeBounds.end_bound" ~can_fail:false;
    (* file: "Aeneas/Std/Slice.lean", line: 922 *)
    mk_fun
      "core::ops::range::{core::ops::range::RangeBounds<core::ops::range::Range<@T>, \
       @T>}::start_bound"
      "core.ops.range.Range.RangeBounds.start_bound" ~can_fail:false;
    (* file: "Aeneas/Std/Slice.lean", line: 955 *)
    mk_fun
      "core::ops::range::{core::ops::range::RangeBounds<core::ops::range::RangeFrom<@T>, \
       @T>}::end_bound"
      "core.ops.range.RangeFrom.RangeBounds.end_bound" ~can_fail:false;
    (* file: "Aeneas/Std/Slice.lean", line: 948 *)
    mk_fun
      "core::ops::range::{core::ops::range::RangeBounds<core::ops::range::RangeFrom<@T>, \
       @T>}::start_bound"
      "core.ops.range.RangeFrom.RangeBounds.start_bound" ~can_fail:false;
    ...
    (* file: "Aeneas/Std/Core/Convert.lean", line: 90 *)
    mk_fun
      "core::result::{core::ops::try_trait::Try<core::result::Result<@T, @E>, \
       @T, core::result::Result<core::convert::Infallible, @E>>}::branch"
    ...
    mk_fun "core::slice::cmp::{core::cmp::Ord<[@T]>}::cmp"
      "core.slice.cmp.OrdSlice.cmp";
    (* file: "Aeneas/Std/Slice.lean", line: 286 *)
    ...
    (* file: "Aeneas/Std/Slice.lean", line: 312 *)
    mk_fun
    ...
    (* file: "Aeneas/Std/Slice.lean", line: 339 *)
    mk_fun
      "core::slice::index::{core::slice::index::SliceIndex<core::ops::range::Range<usize>, \
    ...
    (* file: "Aeneas/Std/Slice.lean", line: 351 *)
    mk_fun
      "core::slice::index::{core::slice::index::SliceIndex<core::ops::range::Range<usize>, \
       [@T], [@T]>}::index_mut"
      "core.slice.index.SliceIndexRangeUsizeSlice.index_mut";
    (* file: "Aeneas/Std/Slice.lean", line: 534 *)
    mk_fun
    ...
    (* file: "Aeneas/Std/Slice.lean", line: 479 *)
    mk_fun
      "core::slice::index::{core::slice::index::SliceIndex<usize, [@T], \
       @T>}::get_mut"
    ...
    (* file: "Aeneas/Std/Slice.lean", line: 500 *)
    mk_fun
      "core::slice::index::{core::slice::index::SliceIndex<usize, [@T], \
       @T>}::index_mut"
      "core.slice.index.Usize.index_mut";
    (* file: "Aeneas/Std/SliceIter.lean", line: 212 *)
    mk_fun
    ...
    mk_fun
      "core::slice::iter::{core::iter::traits::iterator::Iterator<core::slice::iter::Iter<'a, \
       @T>, &'a @T>}::collect"
      "core.slice.iter.IteratorSliceIter.collect";
    (* file: "Aeneas/Std/SliceIter.lean", line: 91 *)
    mk_fun
      "core::slice::iter::{core::iter::traits::iterator::Iterator<core::slice::iter::Iter<'a, \
       @T>, &'a @T>}::enumerate"
      "core.slice.iter.IteratorSliceIter.enumerate";
    (* file: "Aeneas/Std/SliceIter.lean", line: 131 *)
    mk_fun
      "core::slice::iter::{core::iter::traits::iterator::Iterator<core::slice::iter::Iter<'a, \
       @T>, &'a @T>}::map"
      "core.slice.iter.IteratorSliceIter.map";
    (* file: "Aeneas/Std/SliceIter.lean", line: 63 *)
    mk_fun
      "core::slice::iter::{core::iter::traits::iterator::Iterator<core::slice::iter::Iter<'a, \
       @T>, &'a @T>}::next"
      "core.slice.iter.IteratorSliceIter.next";
    (* file: "Aeneas/Std/SliceIter.lean", line: 84 *)
    mk_fun
      "core::slice::iter::{core::iter::traits::iterator::Iterator<core::slice::iter::Iter<'a, \
       @T>, &'a @T>}::step_by"
    ...
    (* file: "Aeneas/Std/SliceIter.lean", line: 235 *)
    mk_fun "core::slice::{[@T]}::chunks_exact" "core.slice.Slice.chunks_exact";
    (* file: "Aeneas/Std/Slice.lean", line: 1036 *)
    mk_fun "core::slice::{[@T]}::clone_from_slice"
    ...
    (* file: "Aeneas/Std/Slice.lean", line: 528 *)
    mk_fun "core::slice::{[@T]}::copy_from_slice"
      "core.slice.Slice.copy_from_slice";
    (* file: "Aeneas/Std/Slice.lean", line: 1068 *)
    mk_fun "core::slice::{[@T]}::copy_within" "core.slice.Slice.copy_within";
    (* file: "Aeneas/Std/Slice.lean", line: 292 *)
    mk_fun "core::slice::{[@T]}::get" "core.slice.Slice.get";
    (* file: "Aeneas/Std/Slice.lean", line: 306 *)
    ...
    (* file: "Aeneas/Std/Slice.lean", line: 116 *)
    ...
    (* file: "Aeneas/Std/Slice.lean", line: 47 *)
    mk_fun "core::slice::{[@T]}::len" "Slice.len" ~can_fail:false ~lift:false;
    (* file: "Aeneas/Std/Slice.lean", line: 269 *)
...
let lean_builtin_trait_decls =
  [
    ...
    (* file: "Aeneas/Std/Core/Convert.lean", line: 67 *)
    ...
    (* file: "Aeneas/Std/Core/Convert.lean", line: 45 *)
    ...
    mk_trait_decl "core::fmt::Display" "core.fmt.Display"
      ~methods:[ ("fmt", "fmt") ];
    (* file: "Aeneas/Std/Core/Fmt.lean", line: 60 *)
    ...
    mk_trait_decl "core::iter::traits::accum::Sum" "core.iter.traits.accum.Sum"
      ~methods:[ ("sum", "sum") ];
    (* file: "Aeneas/Std/Core/Iter.lean", line: 323 *)
    mk_trait_decl "core::iter::traits::collect::Extend"
      "core.iter.traits.collect.Extend"
      ~methods:[ ("extend", "extend") ];
    (* file: "Aeneas/Std/Core/Iter.lean", line: 291 *)
    ...
    (* file: "Aeneas/Std/Core/Iter.lean", line: 328 *)
    ...
    (* file: "Aeneas/Std/Core/Iter.lean", line: 334 *)
    ...
    (* file: "Aeneas/Std/Slice.lean", line: 912 *)
    mk_trait_decl "core::ops::range::RangeBounds" "core.ops.range.RangeBounds"
      ~methods:[ ("start_bound", "start_bound"); ("end_bound", "end_bound") ];
    ...
    (* file: "Aeneas/Std/Slice.lean", line: 273 *)
...
let lean_builtin_trait_impls =
  [
    ...
    mk_trait_impl "core::cmp::PartialEq<Box<@T>, Box<@T>>"
      ...
      ~keep_params:(Some [ true; false ]);
    (* file: "Aeneas/Std/Array/ArraySlice.lean", line: 339 *)
    mk_trait_impl "core::cmp::PartialEq<[@T], [@U; @N]>"
      "core.array.equality.PartialEqSliceArray";
    (* file: "Aeneas/Std/Vec.lean", line: 481 *)
    mk_trait_impl
    ...
    (* file: "Aeneas/Std/Core/Convert.lean", line: 30 *)
    mk_trait_impl "core::convert::From<@Self, @Self>" "core.convert.FromSame";
    (* file: "Aeneas/Std/Vec.lean", line: 418 *)
    ...
    (* file: "Aeneas/Std/Array/ArraySlice.lean", line: 194 *)
    mk_trait_impl
    ...
    (* file: "Aeneas/Std/Core/Convert.lean", line: 54 *)
    mk_trait_impl "core::convert::{core::convert::TryInto<@T, @U>}"
      "core.convert.TryIntoFrom";
    (* file: "Aeneas/Std/Array/Array.lean", line: 301 *)
    ...
    (* file: "Aeneas/Std/Vec.lean", line: 644 *)
    ...
    (* file: "Aeneas/Std/Core/Fmt.lean", line: 135 *)
    mk_trait_impl "core::fmt::Debug<()>" "core.fmt.DebugUnit";
    (* file: "Aeneas/Std/Vec.lean", line: 502 *)
    ...
    (* file: "Aeneas/Std/Core/Iter.lean", line: 305 *)
    ...
    mk_trait_impl
      ...
      ~keep_params:(Some [ true; false ]);
    (* file: "Aeneas/Std/Core/Iter.lean", line: 264 *)
    mk_trait_impl
    ...
    (* file: "Aeneas/Std/SliceIter.lean", line: 224 *)
    mk_trait_impl
    ...
    (* file: "Aeneas/Std/Vec.lean", line: 193 *)
    ...
    mk_trait_impl "core::ops::index::IndexMut<alloc::vec::Vec<@T>, @T, @O>"
      ...
      ~keep_params:(Some [ true; true; false; true ]);
    (* file: "Aeneas/Std/Slice.lean", line: 939 *)
    mk_trait_impl
      "core::ops::range::RangeBounds<core::ops::range::Range<@T>, @T>"
      "core.ops.range.Range.RangeBounds";
    (* file: "Aeneas/Std/Slice.lean", line: 961 *)
    mk_trait_impl
      "core::ops::range::RangeBounds<core::ops::range::RangeFrom<@T>, @T>"
      "core.ops.range.RangeFrom.RangeBounds";
    (* file: "Aeneas/Std/Core/Convert.lean", line: 126 *)
    mk_trait_impl
      "core::ops::try_trait::FromResidual<core::result::Result<@T, @F>, \
       core::result::Result<core::convert::Infallible, @E>>"
      "core.result.Result.Insts.CoreOpsTry_traitFromResidualResultInfallibleE";
    (* file: "Aeneas/Std/Core/Convert.lean", line: 138 *)
    mk_trait_impl
      "core::ops::try_trait::Try<core::result::Result<@T, @E>, @T, \
       core::result::Result<core::convert::Infallible, @E>>"
      "core.result.Result.Insts.CoreOpsTry_traitTryTResultInfallibleE";
    (* file: "Aeneas/Std/Slice.lean", line: 374 *)
    mk_trait_impl
      "core::slice::index::SliceIndex<core::ops::range::Range<usize>, [@T], \
       [@T]>"
      "core.slice.index.SliceIndexRangeUsizeSlice";
    (* file: "Aeneas/Std/Slice.lean", line: 599 *)
    mk_trait_impl
      "core::slice::index::SliceIndex<core::ops::range::RangeFrom<usize>, \
       [@T], [@T]>"
      "core.slice.index.SliceIndexRangeFromUsizeSlice";
    (* file: "Aeneas/Std/Slice.lean", line: 1013 *)
    mk_trait_impl
      "core::slice::index::SliceIndex<core::ops::range::RangeFull, [@T], [@T]>"
      "core.slice.index.SliceIndexRangeFullSlice";
    (* file: "Aeneas/Std/Slice.lean", line: 446 *)
    mk_trait_impl
    ...
    (* file: "Aeneas/Std/Slice.lean", line: 974 *)
    mk_trait_impl
      "core::slice::index::private_slice_index::Sealed<core::ops::range::RangeFull>"
      "core.slice.index.private_slice_index.SealedRangeFull";
    ...
    (* file: "Aeneas/Std/Slice.lean", line: 505 *)
