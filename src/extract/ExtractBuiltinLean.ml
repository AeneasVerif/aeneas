...
let lean_builtin_types =
  [
    ...
    (* file: "Aeneas/Std/Vec.lean", line: 27 *)
    ...
    (* file: "Aeneas/Std/Core/Ops.lean", line: 90 *)
    ...
    (* file: "Aeneas/Std/Range.lean", line: 29 *)
    mk_type "core::ops::range::RangeFull" "core.ops.range.RangeFull";
    (* file: "Aeneas/Std/Range.lean", line: 37 *)
...
let lean_builtin_funs =
  [
    ...
    (* file: "Aeneas/Std/Core/Cmp.lean", line: 230 *)
    ...
    (* file: "Aeneas/Std/Vec.lean", line: 387 *)
    mk_fun "alloc::vec::from_elem" "alloc.vec.from_elem";
    (* file: "Aeneas/Std/VecIter.lean", line: 81 *)
    mk_fun
    ...
    mk_fun
      ...
      ~keep_params:(Some [ true; false ]);
    (* file: "Aeneas/Std/Vec.lean", line: 617 *)
    mk_fun
    ...
    (* file: "Aeneas/Std/Vec.lean", line: 627 *)
    mk_fun
      "alloc::vec::partial_eq::{core::cmp::PartialEq<alloc::vec::Vec<@T>, \
       alloc::vec::Vec<@U>>}::ne"
    ...
    mk_fun
      ...
      ~keep_params:(Some [ true; false ]);
    (* file: "Aeneas/Std/Vec.lean", line: 422 *)
    mk_fun
      "alloc::vec::{core::ops::deref::Deref<alloc::vec::Vec<@T>, [@T]>}::deref"
      "alloc.vec.Vec.deref"
      ~keep_params:(Some [ true; false ])
      ~can_fail:false ~lift:false;
    (* file: "Aeneas/Std/Vec.lean", line: 432 *)
    mk_fun
    ...
    (* file: "Aeneas/Std/Array/ArraySlice.lean", line: 345 *)
    ...
    (* file: "Aeneas/Std/SliceIter.lean", line: 89 *)
    mk_fun
    ...
    (* file: "Aeneas/Std/Core/Cmp.lean", line: 21 *)
    ...
    (* file: "Aeneas/Std/Core/Cmp.lean", line: 120 *)
    ...
    (* file: "Aeneas/Std/Core/Cmp.lean", line: 99 *)
    ...
    (* file: "Aeneas/Std/Core/Convert.lean", line: 14 *)
    mk_fun "core::convert::{core::convert::Into<@T, @U>}::into"
      "core.convert.IntoFrom.into";
    (* file: "Aeneas/Std/Core/Convert.lean", line: 41 *)
    ...
    (* file: "Aeneas/Std/Core/Iter.lean", line: 177 *)
    mk_fun
    ...
    (* file: "Aeneas/Std/Scalar/Ops/Add.lean", line: 166 *)
    ...
    (* file: "Aeneas/Std/Core/CoreOption.lean", line: 11 *)
    ...
    (* file: "Aeneas/Std/Core/CoreOption.lean", line: 21 *)
    ...
    (* file: "Aeneas/Std/Core/Convert.lean", line: 79 *)
    mk_fun "core::result::{core::result::Result<@T, @E>}::is_ok"
      "core.result.Result.is_ok";
    (* file: "Aeneas/Std/Core/CoreResult.lean", line: 10 *)
    ...
    (* file: "Aeneas/Std/Slice.lean", line: 625 *)
    mk_fun
    ...
    (* file: "Aeneas/Std/Slice.lean", line: 631 *)
    mk_fun
      "core::slice::index::{core::slice::index::SliceIndex<core::ops::range::RangeFrom<usize>, \
       [@T], [@T]>}::get_mut"
    ...
    (* file: "Aeneas/Std/Slice.lean", line: 657 *)
    mk_fun
      "core::slice::index::{core::slice::index::SliceIndex<core::ops::range::RangeFrom<usize>, \
       [@T], [@T]>}::index"
    ...
    (* file: "Aeneas/Std/Slice.lean", line: 527 *)
    mk_fun
      "core::slice::index::{core::slice::index::SliceIndex<core::ops::range::RangeFull, \
       [@T], [@T]>}::get_unchecked_mut"
    ...
    (* file: "Aeneas/Std/Slice.lean", line: 586 *)
    mk_fun
      "core::slice::index::{core::slice::index::SliceIndex<usize, [@T], \
       @T>}::get_unchecked_mut"
    ...
    (* file: "Aeneas/Std/SliceIter.lean", line: 136 *)
    mk_fun
    ...
    (* file: "Aeneas/Std/Slice.lean", line: 1045 *)
    ...
    (* file: "Aeneas/Std/Slice.lean", line: 50 *)
    ...
    mk_fun "core::slice::{[@T]}::reverse" "core.slice.Slice.reverse"
      ~can_fail:false;
    (* file: "Aeneas/Std/Slice.lean", line: 718 *)
    ...
    (* file: "Aeneas/Std/Slice.lean", line: 789 *)
    ...
    (* file: "Aeneas/Std/StringIter.lean", line: 12 *)
    mk_fun
      "core::str::iter::{core::iter::traits::iterator::Iterator<core::str::iter::Chars<'a>, \
       char>}::next"
...
let lean_builtin_trait_decls =
  [
    ...
    (* file: "Aeneas/Std/Core/Cmp.lean", line: 16 *)
    ...
    (* file: "Aeneas/Std/Core/Cmp.lean", line: 11 *)
    mk_trait_decl "core::cmp::PartialEq" "core.cmp.PartialEq"
      ~methods:[ ("eq", "eq"); ("ne", "ne") ];
    (* file: "Aeneas/Std/Core/Cmp.lean", line: 89 *)
    ...
    (* file: "Aeneas/Std/Core/Convert.lean", line: 69 *)
    mk_trait_decl "core::convert::AsMut" "core.convert.AsMut"
      ~methods:[ ("as_mut", "as_mut") ];
    (* file: "Aeneas/Std/Core/Convert.lean", line: 25 *)
    ...
    (* file: "Aeneas/Std/Core/Convert.lean", line: 47 *)
    ...
    mk_trait_decl "core::iter::traits::exact_size::ExactSizeIterator"
      ...
      ~parent_clauses:[ "iteratorInst" ];
    (* file: "Aeneas/Std/Core/Iter.lean", line: 76 *)
    ...
    (* file: "Aeneas/Std/Slice.lean", line: 336 *)
...
let lean_builtin_trait_impls =
  [
    ...
    mk_trait_impl "core::clone::Clone<Box<@T>>" "core.core.clone.CloneBox"
      ~keep_params:(Some [ true; false ])
      ~keep_trait_clauses:(Some [ true; false ]);
    (* file: "Aeneas/Std/Array/Array.lean", line: 376 *)
    ...
    (* file: "Aeneas/Std/Core/Cmp.lean", line: 235 *)
    ...
    (* file: "Aeneas/Std/Vec.lean", line: 659 *)
    ...
    (* file: "Aeneas/Std/SliceIter.lean", line: 95 *)
    mk_trait_impl
    ...
    (* file: "Aeneas/Std/VecIter.lean", line: 39 *)
    mk_trait_impl
      ...
      ~keep_params:(Some [ true; false ]);
    (* file: "Aeneas/Std/RangeIter.lean", line: 553 *)
    mk_trait_impl
    ...
    (* file: "Aeneas/Std/RangeIter.lean", line: 564 *)
    mk_trait_impl
    ...
    (* file: "Aeneas/Std/Array/Array.lean", line: 474 *)
    ...
    mk_trait_impl "core::ops::deref::Deref<Box<@T>, @T>"
      ...
      ~keep_params:(Some [ true; false ]);
    (* file: "Aeneas/Std/Vec.lean", line: 427 *)
    ...
    mk_trait_impl "core::ops::deref::DerefMut<Box<@T>, @T>"
      ...
      ~keep_params:(Some [ true; false ]);
    (* file: "Aeneas/Std/Vec.lean", line: 438 *)
    ...
    (* file: "Aeneas/Std/Slice.lean", line: 544 *)
    mk_trait_impl
