...
let lean_builtin_funs =
  [
    ...
    mk_fun
      ...
      ~keep_params:(Some [ true; false ]);
    (* file: "Aeneas/Std/Vec.lean", line: 527 *)
    mk_fun
    ...
    (* file: "Aeneas/Std/Vec.lean", line: 558 *)
    ...
    (* file: "Aeneas/Std/Array/ArraySlice.lean", line: 230 *)
    ...
    mk_fun
      ...
      "core.iter.adapters.rev.Rev.Insts.Iterator.take";
    ...
    (* file: "Aeneas/Std/Slice.lean", line: 380 *)
    mk_fun
    ...
    (* file: "Aeneas/Std/Slice.lean", line: 407 *)
    mk_fun
      "core::slice::index::{core::slice::index::SliceIndex<core::ops::range::Range<usize>, \
    ...
    (* file: "Aeneas/Std/Slice.lean", line: 634 *)
    mk_fun
      "core::slice::index::{core::slice::index::SliceIndex<core::ops::range::RangeFrom<usize>, \
       [@T], [@T]>}::index"
    ...
    (* file: "Aeneas/Std/Slice.lean", line: 776 *)
...
let lean_builtin_trait_impls =
  [
    ...
    mk_trait_impl "core::clone::Clone<Box<@T>>" "core.core.clone.CloneBox"
      ~keep_params:(Some [ true; false ])
      ~keep_trait_clauses:(Some [ true; false ]);
    (* file: "Aeneas/Std/Array/Array.lean", line: 304 *)
    ...
    mk_trait_impl "core::cmp::PartialEq<Box<@T>, Box<@T>>"
      ...
      ~keep_params:(Some [ true; false ]);
    (* file: "Aeneas/Std/Vec.lean", line: 548 *)
    mk_trait_impl
    ...
    (* file: "Aeneas/Std/Array/ArraySlice.lean", line: 195 *)
    mk_trait_impl
    ...
    (* file: "Aeneas/Std/Array/Array.lean", line: 390 *)
    ...
    (* file: "Aeneas/Std/Vec.lean", line: 569 *)
    ...
    mk_trait_impl
      "core::iter::traits::double_ended::DoubleEndedIterator<core::slice::iter::Iter<'a, \
       @T>, &'_ @T>"
      "core.slice.iter.Iter.Insts.DoubleEndedIterator";
    ...
    mk_trait_impl
      ...
      "core.iter.traits.iterator.IteratorRev";
    ...
    (* file: "Aeneas/Std/Slice.lean", line: 662 *)
    mk_trait_impl
