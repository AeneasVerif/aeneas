...
attribute [scalar_tac_simps, grind] length_set
...
attribute [simp_lists_simps, grind] getElem?_append_left getElem?_append_right
...
attribute [simp, simp_lists_simps, grind] drop_of_length_le
attribute [scalar_tac_simps, grind] length_drop

attribute [scalar_tac_simps, simp_lists_simps, grind] length_take
...
@[simp_lists_simps, scalar_tac_simps, grind]
...
attribute [simp_lists_simps, grind] getElem?_take_eq_none getElem?_take_of_lt getElem?_drop
...
@[simp, simp_lists_simps, grind] theorem getElem!_range_of_lt (i n: ℕ) (h : i < n) :
  (List.range n)[i]! = i := by
  simp [*]

@[simp, simp_lists_simps, grind] theorem getElem!_range_zero (i n: ℕ) (h : n ≤ i) :
  (List.range n)[i]! = 0 := by
  simp [*]
