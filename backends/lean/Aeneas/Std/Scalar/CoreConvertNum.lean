...
@[simp, scalar_tac_simps, simp_scalar_simps, grind =]
...
@[simp, bvify_simps, grind =] theorem FromUsizeU8.from_bv_eq (x : U8) : (FromUsizeU8.from x).bv = x.bv.setWidth _ := by rfl

@[simp, bvify_simps, grind =] theorem FromUsizeU16.from_bv_eq (x : U16) : (FromUsizeU16.from x).bv = x.bv.setWidth _ := by rfl

@[simp, bvify_simps, grind =] theorem FromUsizeU32.from_bv_eq (x : U32) : (FromUsizeU32.from x).bv = x.bv.setWidth _ := by rfl

@[simp, bvify_simps, grind =] theorem FromUsizeUsize.from_bv_eq (x : Usize) : (FromUsizeUsize.from x).bv = x.bv.setWidth _ := by rfl

@[simp, bvify_simps, grind =] theorem FromU8U8.from_bv_eq (x : U8) : (FromU8U8.from x).bv = x.bv.setWidth _ := by rfl

@[simp, bvify_simps, grind =] theorem FromU16U8.from_bv_eq (x : U8) : (FromU16U8.from x).bv = x.bv.setWidth _ := by rfl

@[simp, bvify_simps, grind =] theorem FromU16U16.from_bv_eq (x : U16) : (FromU16U16.from x).bv = x.bv.setWidth _ := by rfl

@[simp, bvify_simps, grind =] theorem FromU32U8.from_bv_eq (x : U8) : (FromU32U8.from x).bv = x.bv.setWidth _ := by rfl

@[simp, bvify_simps, grind =] theorem FromU32U16.from_bv_eq (x : U16) : (FromU32U16.from x).bv = x.bv.setWidth _ := by rfl

@[simp, bvify_simps, grind =] theorem FromU32U32.from_bv_eq (x : U32) : (FromU32U32.from x).bv = x.bv.setWidth _ := by rfl

@[simp, bvify_simps, grind =] theorem FromU64U8.from_bv_eq (x : U8) : (FromU64U8.from x).bv = x.bv.setWidth _ := by rfl

@[simp, bvify_simps, grind =] theorem FromU64U16.from_bv_eq (x : U16) : (FromU64U16.from x).bv = x.bv.setWidth _ := by rfl

@[simp, bvify_simps, grind =] theorem FromU64U32.from_bv_eq (x : U32) : (FromU64U32.from x).bv = x.bv.setWidth _ := by rfl

@[simp, bvify_simps, grind =] theorem FromU64U64.from_bv_eq (x : U64) : (FromU64U64.from x).bv = x.bv.setWidth _ := by rfl

@[simp, bvify_simps, grind =] theorem FromU128U8.from_bv_eq (x : U8) : (FromU128U8.from x).bv = x.bv.setWidth _ := by rfl

@[simp, bvify_simps, grind =] theorem FromU128U16.from_bv_eq (x : U16) : (FromU128U16.from x).bv = x.bv.setWidth _ := by rfl

@[simp, bvify_simps, grind =] theorem FromU128U32.from_bv_eq (x : U32) : (FromU128U32.from x).bv = x.bv.setWidth _ := by rfl

@[simp, bvify_simps, grind =] theorem FromU128U64.from_bv_eq (x : U64) : (FromU128U64.from x).bv = x.bv.setWidth _ := by rfl

@[simp, bvify_simps, grind =] theorem FromU128U128.from_bv_eq (x : U128) : (FromU128U128.from x).bv = x.bv.setWidth _ := by rfl
...
@[simp, bvify_simps, grind =] theorem FromIsizeI8.from_bv_eq (x : I8) : (FromIsizeI8.from x).bv = x.bv.signExtend _ := by rfl

@[simp, bvify_simps, grind =] theorem FromIsizeI16.from_bv_eq (x : I16) : (FromIsizeI16.from x).bv = x.bv.signExtend _ := by rfl

@[simp, bvify_simps, grind =] theorem FromIsizeI32.from_bv_eq (x : I32) : (FromIsizeI32.from x).bv = x.bv.signExtend _ := by rfl

@[simp, bvify_simps, grind =] theorem FromIsizeIsize.from_bv_eq (x : Isize) : (FromIsizeIsize.from x).bv = x.bv.signExtend _ := by rfl

@[simp, bvify_simps, grind =] theorem FromI8I8.from_bv_eq (x : I8) : (FromI8I8.from x).bv = x.bv.signExtend _ := by rfl

@[simp, bvify_simps, grind =] theorem FromI16I8.from_bv_eq (x : I8) : (FromI16I8.from x).bv = x.bv.signExtend _ := by rfl

@[simp, bvify_simps, grind =] theorem FromI16I16.from_bv_eq (x : I16) : (FromI16I16.from x).bv = x.bv.signExtend _ := by rfl

@[simp, bvify_simps, grind =] theorem FromI32I8.from_bv_eq (x : I8) : (FromI32I8.from x).bv = x.bv.signExtend _ := by rfl

@[simp, bvify_simps, grind =] theorem FromI32I16.from_bv_eq (x : I16) : (FromI32I16.from x).bv = x.bv.signExtend _ := by rfl

@[simp, bvify_simps, grind =] theorem FromI32I32.from_bv_eq (x : I32) : (FromI32I32.from x).bv = x.bv.signExtend _ := by rfl

@[simp, bvify_simps, grind =] theorem FromI64I8.from_bv_eq (x : I8) : (FromI64I8.from x).bv = x.bv.signExtend _ := by rfl

@[simp, bvify_simps, grind =] theorem FromI64I16.from_bv_eq (x : I16) : (FromI64I16.from x).bv = x.bv.signExtend _ := by rfl

@[simp, bvify_simps, grind =] theorem FromI64I32.from_bv_eq (x : I32) : (FromI64I32.from x).bv = x.bv.signExtend _ := by rfl

@[simp, bvify_simps, grind =] theorem FromI64I64.from_bv_eq (x : I64) : (FromI64I64.from x).bv = x.bv.signExtend _ := by rfl

@[simp, bvify_simps, grind =] theorem FromI128I8.from_bv_eq (x : I8) : (FromI128I8.from x).bv = x.bv.signExtend _ := by rfl

@[simp, bvify_simps, grind =] theorem FromI128I16.from_bv_eq (x : I16) : (FromI128I16.from x).bv = x.bv.signExtend _ := by rfl

@[simp, bvify_simps, grind =] theorem FromI128I32.from_bv_eq (x : I32) : (FromI128I32.from x).bv = x.bv.signExtend _ := by rfl

@[simp, bvify_simps, grind =] theorem FromI128I64.from_bv_eq (x : I64) : (FromI128I64.from x).bv = x.bv.signExtend _ := by rfl

@[simp, bvify_simps, grind =] theorem FromI128I128.from_bv_eq (x : I128) : (FromI128I128.from x).bv = x.bv.signExtend _ := by rfl
...
uscalar_no_usize def core.num.«%S».to_le_bytes (x : «%S») : Array U8 (%Size)#usize := ⟨ x.bv.toLEBytes.map UScalar.mk, by
  simp only [List.length_map, UScalar.ofNat_val_eq, @BitVec.toLEBytes_length ((%Size) * 8)] ⟩
...
uscalar_no_usize def core.num.«%S».to_be_bytes (x : «%S») : Array U8 (%Size)#usize := ⟨ x.bv.toBEBytes.map UScalar.mk, by
  simp only [List.length_map, UScalar.ofNat_val_eq, @BitVec.toBEBytes_length ((%Size) * 8)] ⟩
