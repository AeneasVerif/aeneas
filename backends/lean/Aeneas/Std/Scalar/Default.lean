...
uscalar @[expose, simp, scalar_tac_simps] def core.default.Default'S.default : «%S» := ⟨ 0, by scalar_tac ⟩
iscalar @[expose, simp, scalar_tac_simps] def core.default.Default'S.default : «%S» := ⟨ 0, by scalar_tac ⟩
...
scalar @[expose, reducible] def core.default.Default'S : core.default.Default «%S» := {
