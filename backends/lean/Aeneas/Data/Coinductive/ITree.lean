...
/-- A tree below a return is that return, or `div`. -/
...
/-- A chain whose supremum returns a value contains that very return. -/
...
/-- The suprema of the children equals the children of the supremum. -/
